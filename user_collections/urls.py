...
urlpatterns = [
    ...
    path('<uuid:pk>/update/', views.choreography_update, name='update'),  # NEW: API update endpoint
    path('<uuid:pk>/delete/', views.choreography_delete, name='delete'),
    path('save/', views.save_choreography, name='save'),
    path('stats/', views.collection_stats, name='stats'),
    path('cleanup/', views.collection_cleanup, name='cleanup'),  # NEW: Cleanup orphaned files
]
